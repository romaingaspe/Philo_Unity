...
<?php $this->start('main_content') ?>
  ...
  <section id="description" class="container section">
    <div class="row">
      <div id="titleprojet" class="col m6 l4">
      ...
      <div id="slideprojet" class="col m6 l8 slider">
          <ul class="slides">
            <li>
          ...
          <div>
              <a class="waves-effect waves-light btn right btn-com-project">commenter</a>
          </div>
      </div>
  ...
  <section class="container">
    ...
    <div id="com-projects" class="grey lighten-2 ">
  			<h7>gorginette</h7>
