...
<?php $this->start('main_content') ?>
	...
	<div class="container">
		...
		<section id="Objet-des-CGU" class="center-align container card teal lighten-5">

			<p class="card-panel teal bn" style="color:white;">Le présent document a pour objet de définir les modalités et conditions dans lesquelles d’une part, Philomatique , ci-après dénommé l’EDITEUR, met à la disposition de ses utilisateurs le site, et les services disponibles sur le site et d’autre part, la manière par laquelle l’utilisateur accède au site et utilise ses services.Toute connexion au site est subordonnée au respect des présentes conditions.<br>
		...
		<h4 id"titre-CGU" class="center-align container  card- red-text text-lighten-2  bn">3) Responsabilité de l’éditeur</h4></br>
			...
			Toutefois, ces informations et/ou documents sont susceptibles de contenir des inexactitudes techniques et des erreurs typographiques.<br><br>

			L’EDITEUR se réserve le droit de les corriger, dès que ces erreurs sont portées à sa connaissance.<br><br>

			Il est fortement recommandé de vérifier l’exactitude et la pertinence des informations et/ou documents mis à disposition sur ce site.<br><br>
			...
			L’utilisation des informations et/ou documents disponibles sur ce site se fait sous l’entière et seule responsabilité de l’utilisateur, qui assume la totalité des conséquences pouvant en découler, sans que l’EDITEUR puisse être recherché à ce titre, et sans recours contre ce dernier.<br><br>
		...
		<h4 id"titre-CGU" class="center-align container card- red-text text-lighten-2  bn">4) Règles d'usage d'Internet</h4></br>
			...
			L’utilisateur reconnaît que les données circulant sur Internet ne sont pas protégées notamment contre les détournements éventuels. La présence du logo Philomatique Unity institue une présomption simple de validité. La communication de toute information jugée par l’utilisateur de nature sensible ou confidentielle se fait à ses risques et périls.
		...
		<h4 id"titre-CGU" class="center-align container card- red-text text-lighten-2  bn">5) Droit applicable</h4></br>
			...
			Pour toute question relative aux présentes conditions d’utilisation du site, vous pouvez nous écrire à l’adresse suivante :<br><br>Philomatique :66 Rue Abbé de l'Épée, 33000 Bordeaux<br><br>
